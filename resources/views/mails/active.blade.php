...
<div class="email-template" 
	...
	<p><label>Giá người lớn: </label> {{ number_format($data['tour']->detail['price_adults']) }} VND</p>
	<p><label>Giá trẻ em: </label> {{ number_format($data['tour']->detail['price_childs']) }} VND</p>
	<p style="text-align: center;"><b>Tổng tiền: </b> {{ number_format($data['sum']) }} VND</p>
</div>
<br>
Thank You,
<br/>
